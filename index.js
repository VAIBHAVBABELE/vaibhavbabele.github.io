...
function updateModeIcon(mode) {
  ...
  const isDeepPage = [
    ...
    "/pr-contribution",
    "/certificate",
  ].some((subpath) => path.includes("/pages" + subpath));
  ...
  mode.src = document.body.classList.contains("dark-mode")
    ? imgPathPrefix + "sun.png"
    : imgPathPrefix + "moon.png";
}
...
// ===== Google Translate functionality is handled in language.js =====
// This section has been moved to language.js to avoid conflicts
